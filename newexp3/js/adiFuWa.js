...
*/
  ...
  function parame(vm){
    var vrms=vm/Math.sqrt(2);
    var vdc=2*vm/Math.PI;
    ...
    var len=1000;
                ...
                gr = document.getElementById('grph');
                    ...
                    if(cha=='1'){
                      ...
                      var data = [op1];
                      var layout={title: 'Fullwave Rectified Output(Vo)', plot_bgcolor: 'black',paper_bgcolor:'black',
                      font: {
                        family: 'Courier New, monospace',
                        size: 18,
                        color: '#7f7f7f'
                      ...
                      var data = [in1,op1];
                      var layout={title: 'Fullwave Rectifier Plot',plot_bgcolor: 'black',paper_bgcolor:'black',text_color:'blue',
                      font: {
                        family: 'Courier New, monospace',
                        size: 18,
                        color: '#7f7f7f'
                      ...
                      var data = [];
                      var layout={title: 'Fullwave Rectifier Plot',plot_bgcolor: 'black',paper_bgcolor:'black',
                      font: {
                        family: 'Courier New, monospace',
                        size: 18,
                        color: '#7f7f7f'
